...
public class ViewNode<V extends View> {
    private final ViewType<V> mType;
    private final LayoutParamsType mLayoutParamsType;
    private final List<Property> mViewProperties;
    private final List<Property> mLayoutProperties;
