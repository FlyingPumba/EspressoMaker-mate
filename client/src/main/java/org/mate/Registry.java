...
public class Registry {
    ...
    /**
     * The algorithm instance that MATE is currently running.
     */
    private static Algorithm runningAlgorithm;
    ...
    public static void registerRunningAlgorithm(Algorithm algorithm) {
        Registry.runningAlgorithm = algorithm;
    }

    public static Algorithm getRunningAlgorithm() {
        return Registry.runningAlgorithm;
    }
}
